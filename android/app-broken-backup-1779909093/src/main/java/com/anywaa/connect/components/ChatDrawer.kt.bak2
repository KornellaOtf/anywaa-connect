...
import com.anywaa.connect.viewmodels.ChatDrawerViewModel
...
fun ChatDrawer(
    ...
    var creatorToEdit by remember { mutableStateOf<com.anywaa.connect.data.CreatorEntity?>(null) }
    var chatToDelete by remember { mutableStateOf<ChatEntity?>(null) }
    var creatorToDelete by remember { mutableStateOf<com.anywaa.connect.data.CreatorEntity?>(null) }
    
    // ... dialog logic ...
    
    if (chatToRename != null) {
        com.anywaa.connect.screens.RenameChatDialog(
...
private fun CreatorEditDialog(
    creator: com.anywaa.connect.data.CreatorEntity,
    onConfirm: (com.anywaa.connect.data.CreatorEntity) -> Unit,
    onDismiss: () -> Unit
) {
