...
import com.anywaa.connect.navigation.AnywaaConnectNavigation
import com.anywaa.connect.ui.theme.AnywaaConnectTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val app = application as AnywaaConnectApplication
        ...
        setContent {
            ...
            AnywaaConnectTheme(themeMode = currentThemeMode) {
        ...
        // Ads/consent flows are disabled for this build.
    }
    
    override fun attachBaseContext(newBase: Context) {
        // Get the saved language preference and apply locale configuration
        val themePrefs = com.anywaa.connect.data.ThemePreferences(newBase)
