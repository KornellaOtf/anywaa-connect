...
import com.anywaa.connect.websearch.WebSearchService
import com.anywaa.connect.websearch.DuckDuckGoSearchService
import com.anywaa.connect.websearch.SearchIntentDetector
...
// // import com.anywaa.connect.util.LlmInference
// // import com.anywaa.connect.util.LlmInferenceSession
...
//                         com.google.mediapipe.tasks.genai.llminference.GraphOptions.builder()
    ...
    override suspend fun generateResponse(prompt: String, model: LLMModel): String {
        ...
        val kidModeManager = com.anywaa.connect.utils.KidModeManager(applicationContext)
        var finalPrompt = prompt
        if (kidModeManager.isKidModeEnabled.value) {
            Log.d(TAG, "Global Injection: Injecting Kid Mode Instruction")
            val kidInstruction = com.anywaa.connect.utils.KidModeManager.SYSTEM_INSTRUCTION
