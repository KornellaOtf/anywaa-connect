package com.anywaa.connect.service
...
class ModelDownloadService : Service() {
    ...
    companion object {
        const val ACTION_DOWNLOAD_PROGRESS = "com.anywaa.connect.DOWNLOAD_PROGRESS"
        const val ACTION_DOWNLOAD_COMPLETED = "com.anywaa.connect.DOWNLOAD_COMPLETED"
        const val ACTION_DOWNLOAD_ERROR = "com.anywaa.connect.DOWNLOAD_ERROR"
        const val ACTION_PAUSE_DOWNLOAD = "com.anywaa.connect.PAUSE_DOWNLOAD"
        const val EXTRA_MODEL_NAME = "model_name"
        const val EXTRA_DOWNLOADED_BYTES = "downloaded_bytes"
        const val EXTRA_TOTAL_BYTES = "total_bytes"
        const val EXTRA_DOWNLOAD_SPEED = "download_speed"
        const val EXTRA_ERROR_MESSAGE = "error_message"
        const val ACTION_CANCEL_DOWNLOAD = "com.anywaa.connect.CANCEL_DOWNLOAD"
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val requirements = com.anywaa.connect.data.ModelRequirements(minRamGB, recommendedRamGB)
    ...
    private fun cancelDownload(modelName: String) {
        ...
        val model = com.anywaa.connect.data.LLMModel(
            name = modelName,
            description = "",
            url = "",
            category = "",
            ...
            supportsGpu = false,
            requirements = com.anywaa.connect.data.ModelRequirements(4, 8)
        )
