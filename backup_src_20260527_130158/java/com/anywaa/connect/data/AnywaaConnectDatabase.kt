...
@Database(
    entities = [ChatEntity::class, MessageEntity::class, MemoryDocument::class, com.anywaa.connect.data.MemoryChunkEmbedding::class, CreatorEntity::class],
    version = 5,
    exportSchema = false
)
abstract class AnywaaConnectDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile
        private var INSTANCE: AnywaaConnectDatabase? = null
        ...
        fun getDatabase(context: Context): AnywaaConnectDatabase {
            return INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(
                    context.applicationContext,
                    AnywaaConnectDatabase::class.java,
                    "anywaaconnect_database"
                )
