...
object ModelData {
    val models = listOf(
        // Gemma 4 E2B (Dha-Anywaa)
        LLMModel(
            name = "Gemma 4 E2B (Dha-Anywaa)",
            description = "Optimised for Dha-Anywaa language and culture. Works offline. (2.6GB)",
            url = "https://huggingface.co/ggml-org/gemma-4-E2B-it-GGUF/resolve/main/gemma-4-E2B-it-Q4_K_M.gguf?download=true",
            category = "text",
            sizeBytes = 2600000000L, // 2.6 GB
            source = "Dha-Anywaa Fine-Tune class",
